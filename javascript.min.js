(function (a) {
    ...
    a.defineMode("javascript", function (Z, aj) {
        ...
        var ar = function () {
            function aQ(aS) {
                return {type: aS, style: "keyword"}
            }

            var aL = aQ("keyword a"), aJ = aQ("keyword b"), aI = aQ("keyword c");
            var aK = aQ("operator"), aO = {type: "atom", style: "atom"};
            var aM = {
                "if": aQ("if"),
                "while": aL,
                "with": aL,
            ...
            if (g) {
                var aR = {type: "variable", style: "variable-3"};
                var aN = {
        ...
        function av(aJ) {
            ...
            if (aK.context) {
                ...
                aK.localVars = {name: aJ, next: aK.localVars}
            } else {
                if (aI(aK.globalVars)) {
                    return
                }
                if (aj.globalVars) {
                    aK.globalVars = {name: aJ, next: aK.globalVars}
                }
            }
        }

        var q = {name: "this", next: {name: "arguments"}};

        function w() {
            D.state.context = {prev: D.state.context, vars: D.state.localVars};
            D.state.localVars = q
        }
        ...
        return {
            startState: function (aJ) {
                var aI = {
                    ...
                    context: aj.localVars && {vars: aj.localVars},
                    indented: 0
                };
            ...
            indent: function (aO, aI) {
                ...
                var aN = aI && aI.charAt(0), aL = aO.lexical;
                if (!/^\s*else\b/.test(aI)) {
